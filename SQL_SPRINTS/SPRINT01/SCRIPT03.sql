...
CREATE TYPE "equaly_adm".USER_ROLE AS ENUM('EVENT_OPENER','QUALITY_INSPECTOR','RNC_REPORTER','IT_MANAGER');
CREATE TYPE "equaly_adm".USER_SUBROLE AS ENUM('ADMIN','DEFAULT');
...
CREATE TABLE IF NOT EXISTS "equaly_adm"."USER" (
	...
	"ROLE" "equaly_adm".USER_ROLE NOT NULL,
	"SUBROLE" "equaly_adm".USER_SUBROLE NOT NULL,
	"IS_ACTIVE" BOOLEAN NOT NULL DEFAULT TRUE,
